...
#' @param gamma Acceptable risk of overbooking
...
ntickets = function(N, gamma, p) {
  ...
  absDiff = abs(sapply(possibleValues, nddistribution))
  #To find the n with the minimum objective value
  nd = possibleValues[which.min(absDiff)]
  ...
  abline(h = ncdistribution(nc), col = "blue", lwd = 2)
